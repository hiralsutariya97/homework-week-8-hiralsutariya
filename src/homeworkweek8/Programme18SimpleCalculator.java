...
public class Programme18SimpleCalculator {
    ...
    public static void main(String[] args) {
        Programme18SimpleCalculator c = new Programme18SimpleCalculator();
        c.setFirstNumber(5.0);
        c.setSecondNumber(4);
        System.out.println("add = " + c.getAdditionResult());
        System.out.println("subtract = " + c.getSubtractionResult());
        c.setFirstNumber(5.25);
        c.setSecondNumber(0);
        System.out.println("multiply = " + c.getMultiplicationResult());
        System.out.println("divide = " + c.getDivisionResult());
    }
}
